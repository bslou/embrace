  ...
  return (
    <Flex direction={"column"} alignItems={"center"} width={"100%"}>
      ...
      <Flex
        ...
        marginBottom={5}
      >
        <Image src={info[ind].img} alt={info[ind].name} width={"47.5%"} />
        <Flex
          direction={"column"}
        ...
        >
          ...
          <Flex alignItems={"center"} justifyContent={"center"} gap={3}>
            ...
            <Text color={"orange"} fontSize={"21pt"}>
              ${info[ind].final}
            </Text>
            <Button
          ...
          <Flex alignItems={"center"} gap={3}>
            ...
            <Text fontSize={"18pt"}>({info[ind].reviews})</Text>
          </Flex>
          <Text>Quantity</Text>
          ...
          <Text textAlign={"center"} fontSize={"12pt"}>
